          ...
          <div class="page-heading">
               <section>
                    ...
                    <form action="index.php?act=add-sp" method="post" enctype="multipart/form-data">
                         <div class="mb-3">
                              <select class="form-select" aria-label="Default select example" name="iddm" required>
                         ...
                         <div class="mb-3">
                              ...
                              <input type="file" class="form-control" id="exampleInputText" name="hinh"  required>
                         </div>
                         <div class="mb-3">
